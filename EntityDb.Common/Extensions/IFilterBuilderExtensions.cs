...
namespace EntityDb.Common.Extensions
{
    ...
    public static class IFilterBuilderExtensions
    {
        ...
        /// <returns>A <typeparamref name="TFilter"/> that excludes objects which do match all filters in <paramref name="filters"/>.</returns>
        ...
        /// <param name="filterBuilder">The filter builder.</param>
        /// <param name="filters">The set of filters.</param>
        /// <returns>A <typeparamref name="TFilter"/> that excludes objects which do match any filter in <paramref name="filters"/>.</returns>
        ...
        /// <returns>A <typeparamref name="TFilter"/> that only includes objects which only match <paramref name="filterA"/> or only match <paramref name="filterB"/>.</returns>
        ...
        /// <param name="filterA">The first filter.</param>
        /// <param name="filterB">The second filter.</param>
        /// <returns>A <typeparamref name="TFilter"/> that excludes objects which only match <paramref name="filterA"/> or only match <paramref name="filterB"/>.</returns>
        public static TFilter Xnor<TFilter>(this IFilterBuilder<TFilter> filterBuilder, TFilter filterA, TFilter filterB)
        {
            return filterBuilder.Not
            (
