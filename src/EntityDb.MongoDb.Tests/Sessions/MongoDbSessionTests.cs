...
//            var mongoDbSession = new MongoDbSession<TransactionEntity>(default!, default!, _logger, default!);

//            var mongoDbRepository = new MongoDbTransactionRepository<TransactionEntity>(mongoDbSession, mongoDbSession);
