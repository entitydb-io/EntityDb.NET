...
namespace EntityDb.MongoDb.Provisioner.Extensions
{
    ...
    {
        /// <summary>
        /// Adds an auto-provision, test-mode implementation of <see cref="ITransactionRepositoryFactory{TEntity}"/> to a service collection.
        /// </summary>
        ...
        /// </remarks>
        public static void AddAutoProvisionTestModeMongoDbTransactions<TEntity>(this IServiceCollection serviceCollection, string databaseName, Func<IServiceProvider, string> getConnectionString)
        {
            serviceCollection.AddSingleton<ITransactionRepositoryFactory<TEntity>>((serviceProvider) =>
            {
                ...
                return AutoProvisionTestModeMongoDbTransactionRepositoryFactory<TEntity>.Create(serviceProvider, connectionString, databaseName);
            });
        }
    }
}
