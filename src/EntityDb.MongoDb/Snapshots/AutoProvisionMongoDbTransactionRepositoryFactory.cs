...
internal sealed class AutoProvisionMongoDbSnapshotRepositoryFactory<TSnapshot> : MongoDbSnapshotRepositoryFactoryWrapper<TSnapshot>
{
    ...
    public static IMongoDbSnapshotRepositoryFactory<TSnapshot> Create(IServiceProvider serviceProvider,
        IMongoDbSnapshotRepositoryFactory<TSnapshot> mongoDbSnapshotRepositoryFactory)
    {
        return ActivatorUtilities.CreateInstance<AutoProvisionMongoDbSnapshotRepositoryFactory<TSnapshot>>(serviceProvider,
