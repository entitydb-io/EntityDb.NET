...
using EntityDb.MongoDb.Documents.Serializers;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Logging;
using MongoDB.Bson;
using MongoDB.Bson.Serialization;
using MongoDB.Bson.Serialization.Serializers;
using VersionSerializer = EntityDb.MongoDb.Documents.Serializers.VersionSerializer;
...
internal class MongoDbEnvelopeService : IEnvelopeService<BsonDocument>
{
    ...
    static MongoDbEnvelopeService()
    {
        ...
        BsonSerializer.RegisterSerializer(new VersionSerializer());
    }
    ...
    public TData Deserialize<TData>(BsonDocument serializedData)
    {
        ...
        {
            var envelope =
                (Envelope<BsonDocument>)BsonSerializer.Deserialize(serializedData, typeof(Envelope<BsonDocument>));
