...
namespace EntityDb.Abstractions.Queries.FilterBuilders
{
    ...
    {
        /// <summary>
        ///     Returns a <typeparamref name="TFilter" /> that only includes sources with any entity id which is contained in a set
        ///     of entity ids.
        /// </summary>
        /// <param name="entityIds">The set of entity ids.</param>
        /// <returns>
        ///     A <typeparamref name="TFilter" /> that only includes sources with any entity id which is contained in
        ///     <paramref name="entityIds" />.
        /// </returns>
        TFilter EntityIdsIn(params Guid[] entityIds);

        /// <summary>
        ///     Returns a <typeparamref name="TFilter" /> that only includes sources whose type is contained in a set of source
        ///     types.
        /// </summary>
        /// <param name="sourceTypes">The source types.</param>
        /// <returns>
        ///     A <typeparamref name="TFilter" /> that only includes sources whose type is contained in
        ///     <paramref name="sourceTypes" />.
        /// </returns>
        ...
        /// <returns>
        ///     A <typeparamref name="TFilter" /> that only includes sources which do match
        ///     <paramref name="sourceExpression" />.
        /// </returns>
