namespace EntityDb.Abstractions.Strategies
{
    ...
    public interface ISnapshottingStrategy<TEntity>
    {
        ...
        /// <returns><c>true</c> if the next version of the entity should be put into snapshot storage, or <c>false</c> if the next version of the entity should not be put into snapshot storage.</returns>
