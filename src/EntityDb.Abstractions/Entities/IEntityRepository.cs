...
namespace EntityDb.Abstractions.Entities
{
    ...
    {
        /// <summary>
        ///     Returns the most recent snapshot of a <typeparamref name="TEntity" /> or constructs a new <typeparamref name="TEntity" />.
        /// </summary>
        ...
        Task<TEntity> GetSnapshotOrConstruct(Guid entityId);
