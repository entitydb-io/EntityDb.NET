...
/// </summary>
public interface IMessageGroupQuery : IQuery
{
    /// <summary>
    ...
    TFilter GetFilter<TFilter>(IMessageGroupFilterBuilder<TFilter> builder);
    ...
    TSort? GetSort<TSort>(IMessageGroupSortBuilder<TSort> builder);
}
