...
{
    internal sealed record SourceReverseSortBuilder<TSort>
        (ISourceSortBuilder<TSort> SourceSortBuilder) : ReverseSortBuilderBase<TSort>(SourceSortBuilder),
            ISourceSortBuilder<TSort>
    {
