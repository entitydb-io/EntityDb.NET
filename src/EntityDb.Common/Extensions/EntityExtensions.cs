...
namespace EntityDb.Common.Extensions
{
    ...
    public static class EntityExtensions
    {
        ...
        /// <returns>
        ///     A new <typeparamref name="TEntity" /> that incorporates the modification of <paramref name="fact" /> into
        ...
        /// <returns>
        ///     A new <typeparamref name="TEntity" /> that incorporates the modifications of <paramref name="facts" /> into
        ///     <paramref name="entity" />.
        /// </returns>
        ...
        /// <param name="command">The command to execute.</param>
        /// <returns>
        ///     A new instace of <typeparamref name="TEntity" /> that incorporates the modifications of
        ...
        /// <summary>
        ///     Returns a new instace of <typeparamref name="TEntity" /> that incorporates the modifications of a set of commands
        ///     into an entity.
        /// </summary>
        /// <typeparam name="TEntity">The type of the entity to be modified.</typeparam>
        /// <param name="entity">The entity to be modified.</param>
